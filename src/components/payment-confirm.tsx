...
const KeypadButton = ({ value, letters, onClick }: { value: string, letters?: string, onClick: (value: string) => void }) => (
    <Button
        variant="ghost"
        className="text-4xl font-light h-20 w-full rounded-xl focus:bg-muted/80 flex flex-col items-center justify-center gap-0 leading-none"
        ...
        <div className="flex flex-col h-full bg-background">
            ...
            <main className="flex-1 flex flex-col justify-between p-4">
                <div className="space-y-8 text-center">
                     ...
                     <div className="flex items-center justify-center gap-2">
                        <div className="flex items-baseline">
                             <span className="text-6xl font-light text-muted-foreground">{currencySymbol}</span>
                            <span className="text-6xl font-light tracking-tighter" style={{ minWidth: '1ch' }}>
                                {formattedAmount}
                ...
                <div className="flex-shrink-0 space-y-4">
                     <div className="flex gap-2">
                         <Sheet open={isNoteSheetOpen} onOpenChange={setIsNoteSheetOpen}>
                            <SheetTrigger asChild>
                                <Button variant="outline" className="h-14 rounded-full text-base flex-grow bg-muted/50">
                    ...
                    <div className="grid grid-cols-3 gap-1 p-1 bg-muted/20 rounded-xl">
                        ...
                        <Button variant="ghost" className="h-20" onClick={handleDelete}>
